...
#7-IQTREE_DNA_matrices_creation.py - Generate IQTREE file for DNA characters

#input file: Two files created by 2MATRIX software
#command line example: python Scripts/7-IQTREE_DNA_matrices_creation.py Example/II-temporary_files/Example2.phy Example/II-temporary_files/Example2.part
